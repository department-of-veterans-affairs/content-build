...
ADD \
  ...
  https://raw.githubusercontent.com/department-of-veterans-affairs/platform-va-ca-certificate/main/VA-Internal-S2-RCA2.cer \
  https://raw.githubusercontent.com/department-of-veterans-affairs/platform-va-ca-certificate/main/VA-Internal-S2-ICA11.cer \
...
RUN \
  ...
  && openssl x509 -inform DER -in /usr/local/share/ca-certificates/VA-Internal-S2-RCA2.cer -out /usr/local/share/ca-certificates/VA-Internal-S2-RCA2.crt \
  && openssl x509 -inform DER -in /usr/local/share/ca-certificates/VA-Internal-S2-ICA11.cer -out /usr/local/share/ca-certificates/VA-Internal-S2-ICA11.crt
