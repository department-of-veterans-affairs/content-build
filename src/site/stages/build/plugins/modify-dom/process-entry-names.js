...
function getEntryNamesDictionary(buildOptions) {
  ...
  const fileManifestPath = path.join(
    'build',
    buildOptions.buildtype,
  ...
  return new Map(Object.entries(JSON.parse(fs.readFileSync(fileManifestPath))));
}

module.exports = {
  initialize(buildOptions) {
    this.entryNamesDictionary = getEntryNamesDictionary(buildOptions);
  },
