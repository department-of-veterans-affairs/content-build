...
Used in [the Drupal client](https://va.ghe.com/software/vets-website/blob/main/src/site/stages/build/drupal/api.js)'s `proxyFetch` function when using a local VA CMS instance.